...
int main() {
	...
	cout << "[DOUBLE]" << endl;
	cout << "d_1 = " << f_1 << " | тип: float, размер: 8 байта" << endl;
	cout << "d_2 = " << f_2 << " | тип: float, размер: 8 байта" << endl;
	cout << "d_3 = " << f_3 << " | тип: float, размер: 8 байта" << endl;
	cout << "d_4 = " << f_4 << " | тип: float, размер: 8 байта" << endl;
	cout << "d_5 = " << f_5 << " | тип: float, размер: 8 байта" << endl << endl;
